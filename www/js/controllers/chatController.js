angular.module('starter').controller('ChatController', function($scope, $ionicFrostedDelegate, $ionicScrollDelegate, $rootScope,dateFilter, $stateParams,$timeout,$ionicLoading,$rootScope) {
